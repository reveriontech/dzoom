...
# Bash equivalent of myrundev.ps1 for macOS/Linux

export LOGLEVEL="info"

export PORT="8081"
export USE_SECURE="yes"
export ENV="pro"

export GOOGLE_APPLICATION_CREDENTIALS="/Users/rodalbores/nogales/nogales-videocall/credentials/local-volt-431316-m2-4fe954a04994.json"
...
export EMAIL_SENDER="no_reply@nogalespsychological.com"
